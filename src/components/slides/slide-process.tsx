...
const steps = [
  ...
  },
  {
    ...
    desc: "We go live on your domain. 30 days support included, ongoing care available.",
  },
];
        ...
        <div className="mt-4 space-y-2">
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                key={step.num}
                className="flex gap-2.5 rounded-lg border border-border/40 bg-card/20 p-2.5"
