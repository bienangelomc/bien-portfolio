...
export default function SlideWorkIndex({ isActive, onOpenHologram }: SlideProps) {
  return (
    <div className="relative flex h-full w-full items-start justify-start overflow-y-auto bg-white p-3 sm:p-4 md:p-6 dark:bg-zinc-950 sm:items-center sm:justify-center">
      <motion.div
