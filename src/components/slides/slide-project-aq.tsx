    ...
    <div className="flex h-full w-full items-center justify-center overflow-hidden bg-zinc-950 p-1.5 sm:p-3 md:p-5">
      ...
      >
        ...
        <p className="mt-0.5 text-[6px] text-muted-foreground sm:text-xs md:text-sm line-clamp-2">
          Cleaning business website for South West WA — local SEO, online quotes, lead conversion.
        </p>
        ...
        <div className="mt-1 grid grid-cols-3 gap-1 sm:mt-3 sm:gap-2">
          <div className="rounded border border-border/40 bg-card/20 px-1 py-0.5 text-center sm:p-2">
            <p className="text-[8px] font-bold text-accent sm:text-sm md:text-lg">6</p>
            <p className="text-[4.5px] text-muted-foreground sm:text-[8px] md:text-[10px]">Services</p>
          </div>
          <div className="rounded border border-border/40 bg-card/20 px-1 py-0.5 text-center sm:p-2">
            <p className="text-[8px] font-bold text-accent sm:text-sm md:text-lg">12</p>
            <p className="text-[4.5px] text-muted-foreground sm:text-[8px] md:text-[10px]">Towns</p>
          </div>
          <div className="rounded border border-border/40 bg-card/20 px-1 py-0.5 text-center sm:p-2">
            <p className="text-[8px] font-bold text-accent sm:text-sm md:text-lg">24/7</p>
            <p className="text-[4.5px] text-muted-foreground sm:text-[8px] md:text-[10px]">Quotes</p>
          </div>
        </div>
        ...
        <div className="mt-1 flex items-center justify-between sm:mt-3">
          <div className="flex flex-wrap gap-0.5 sm:gap-1.5">
            {["Marketing site", "Local SEO", "Lead capture"].map((tag) => (
              <span
                key={tag}
