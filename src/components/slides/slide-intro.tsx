...
export default function SlideIntro({ isActive, onNavigate }: SlideProps) {
  return (
    <div className="relative flex h-full w-full items-start justify-center pt-3 sm:items-center sm:pt-0 overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-950 p-1.5 sm:p-3 md:p-6">
      {/* Background accent */}
      <div
